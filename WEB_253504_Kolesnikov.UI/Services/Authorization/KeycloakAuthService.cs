...
namespace WEB_253504_Kolesnikov.UI.Services.Authorization
{
    ...
    public class KeycloakAuthService : IAuthService
    {
        ...
        public KeycloakAuthService(IHttpClientFactory httpClientFactory, IOptions<KeycloakData> options, 
