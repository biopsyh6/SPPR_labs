...
namespace WEB_253504_Kolesnikov.API.Services.MovieService
{
    public interface IMovieService
    {
        ...
        /// <returns></returns>
        public Task<ResponseData<ProductListModel<Movie>>> GetMovieListAsync(string? categoryNormalizedName, int pageNo = 1, int pageSize=3);
        /// <summary>
        /// Поиск объекта по Id
        /// </summary>
        ...
        /// <returns></returns>
        public Task<ResponseData<bool>> UpdateMovieAsync(int id, Movie product);
        /// <summary>
        /// Удаление объекта
        /// </summary>
        ...
        public Task<ResponseData<int>> CreateMovieAsync(Movie product);
